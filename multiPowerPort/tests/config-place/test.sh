...
EOF
  ...
  echo "Use simple configuration with a single resource RemotePlace"
  ...
  RUNS labgrid-client -c $(dirname ${0})/config-place.yaml del-match ame-odroidc4/ultra96-example/NetworkSiSPMPowerPort/SiSPM-Port2
  RUNS labgrid-client -c $(dirname ${0})/config-place.yaml del-match ame-odroidc4/ultra96-example/NetworkUSBPowerPort/USBPowerPort
  ...
  RUNS labgrid-client -c $(dirname ${0})/config-place.yaml add-named-match ame-odroidc4/ultra96-example/NetworkUSBPowerPort/USBPowerPort main#USBPowerPort
...
targets:
  main:
    ...
    drivers:
      SiSPMPowerDriver: {}
EOF
  echo "Use simple configuration with a single resource RemotePlace and a single PowerDriver"
  cat $(dirname ${0})/config-place.yaml
  regress
  RUNS labgrid-client -c $(dirname ${0})/config-place.yaml del-match ame-odroidc4/ultra96-example/NetworkSiSPMPowerPort/SiSPM-Port1
  RUNS labgrid-client -c $(dirname ${0})/config-place.yaml del-match ame-odroidc4/ultra96-example/NetworkSiSPMPowerPort/SiSPM-Port2
...
function regress() {
  ...
  RUNS labgrid-client -c $(dirname ${0})/config-place.yaml add-named-match ame-odroidc4/ultra96-example/NetworkSiSPMPowerPort/SiSPM-Port1 SiSPM-Port1
  RUNS labgrid-client -c $(dirname ${0})/config-place.yaml lock
  RUNS labgrid-client -c $(dirname ${0})/config-place.yaml power get
  RUNS labgrid-client -c $(dirname ${0})/config-place.yaml power off
  RUNS labgrid-client -c $(dirname ${0})/config-place.yaml power get -n SiSPM-Port1
  RUNS labgrid-client -c $(dirname ${0})/config-place.yaml power off -n SiSPM-Port1
  NRUNS labgrid-client -c $(dirname ${0})/config-place.yaml power get -n SiSPM-Port2
  NRUNS labgrid-client -c $(dirname ${0})/config-place.yaml power off -n SiSPM-Port2
  RUNS labgrid-client -c $(dirname ${0})/config-place.yaml release
  ...
  RUNS labgrid-client -c $(dirname ${0})/config-place.yaml del-match ame-odroidc4/ultra96-example/NetworkSiSPMPowerPort/SiSPM-Port2
  RUNS labgrid-client -c $(dirname ${0})/config-place.yaml add-named-match ame-odroidc4/ultra96-example/NetworkSiSPMPowerPort/SiSPM-Port1 main#dut
  RUNS labgrid-client -c $(dirname ${0})/config-place.yaml add-named-match ame-odroidc4/ultra96-example/NetworkSiSPMPowerPort/SiSPM-Port2 main#tools
  RUNS labgrid-client -c $(dirname ${0})/config-place.yaml lock
  NRUNS labgrid-client -c $(dirname ${0})/config-place.yaml power get
  NRUNS labgrid-client -c $(dirname ${0})/config-place.yaml power off
  RUNS labgrid-client -c $(dirname ${0})/config-place.yaml release
  ...
  RUNS labgrid-client -c $(dirname ${0})/config-place.yaml add-named-match ame-odroidc4/ultra96-example/NetworkSiSPMPowerPort/SiSPM-Port1 main#dut
  RUNS labgrid-client -c $(dirname ${0})/config-place.yaml add-named-match ame-odroidc4/ultra96-example/NetworkSiSPMPowerPort/SiSPM-Port2 tools
  RUNS labgrid-client -c $(dirname ${0})/config-place.yaml add-named-match ame-odroidc4/ultra96-example/NetworkUSBPowerPort/USBPowerPort USBPowerPort
  RUNS labgrid-client -c $(dirname ${0})/config-place.yaml lock
  RUNS labgrid-client -c $(dirname ${0})/config-place.yaml power get
  RUNS labgrid-client -c $(dirname ${0})/config-place.yaml power off
  # uhubctl isn't installed - check for ssh error message - unknown command
  NRUNS labgrid-client -c $(dirname ${0})/config-place.yaml power get -n USBPowerPort
  GREP non-zero
  RUNS labgrid-client -c $(dirname ${0})/config-place.yaml release
}
